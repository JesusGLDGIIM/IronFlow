...
import { Dumbbell, Calendar as CalendarIcon, Settings, BarChart3 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
        ...
        <nav className="flex items-center bg-zinc-100 p-1 rounded-xl w-full md:w-auto overflow-x-auto no-scrollbar scroll-smooth">
          <button
            ...
            className={cn(
              "flex-1 md:flex-none flex items-center justify-center gap-2 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-semibold transition-all whitespace-nowrap",
